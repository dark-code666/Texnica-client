...
import { useFinalInspections } from '../../hooks/finalInspections/useFinalInspections';
...
const emptyForm = {
  ...
  Inspector: '', Disposition: 'Hold', ReportLink: '', Comments: '',
};
...
const FinalInspectionPage: React.FC = () => {
  ...
  const [viewItem, setViewItem] = useState<FinalInspection | null>(null);
  ...
  const openEdit = (item: FinalInspection) => {
    ...
    setForm({
      ...
      Inspector: item.inspector ?? '', Disposition: item.disposition || 'Hold',
      ...
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
        <Box>
          <Typography variant="h5" sx={{ fontWeight: 700 }}>
            <WorkspacePremiumIcon sx={{ mr: 1, verticalAlign: 'middle', color: 'primary.main' }} />
            Final Inspection
          </Typography>
          <Typography variant="body2" color="text.secondary" sx={{ mt: 0.5 }}>
            Inspección final AQL antes del embarque (Result automático)
          </Typography>
        </Box>
        ...
        <TableContainer>
          <Table size="small">
            ...
            <TableBody>
              ...
              ) : items.map((item: FinalInspection) => (
