...
import { endlineInspectionsApi } from '../../utils/api';
import { EndlineInspection } from '../../types';

const mapEndlineInspection = (raw: any): EndlineInspection => ({
  id: raw.id ?? raw.ID ?? 0,
...
/** Hook de Endline Inspection: consume /api/endline-inspections */
export const useEndlineInspections = () =>
  useResource<EndlineInspection>(endlineInspectionsApi, mapEndlineInspection);
